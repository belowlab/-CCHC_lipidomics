# Modified from ~/CCHC/lipidomics/code/2-1_GWAS_filter_suggestive_sig_hits_only.py
# To run this code use:
# python filter_GWAS_results.py --input input_file --output output_path --threshold 1e-3
