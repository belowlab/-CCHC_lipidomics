...
python 01_elastic_net_sklearn_model_txt_file.py --output lipid_species_l1_0.5_100-199.txt \
...
parser.add_argument('--dosage_db', type=str, default='',
                    help='Dosages saved in SQL database. If provided, will ignore --dosage_dir and --dosage_fn')
