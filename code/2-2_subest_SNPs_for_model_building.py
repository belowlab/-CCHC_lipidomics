...
# python 2-2_subest_SNPs_for_model_building.py --input input_file --output output_path --threshold 1e-3
...
parser.add_argument('-t', '--threshold', type=float, default=1e-3) # Threshold to filter SNPs
